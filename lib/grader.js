...
async function callGroq(m, { system, message, json }) {
  const payload = {
    ...
    // gpt-oss are reasoning models — keep reasoning short so grading stays fast.
    reasoning_effort: "low",
  };
  // Strict JSON schema enforces our exact grade shape (both gpt-oss models
  // support strict structured outputs); GRADE_SCHEMA is already strict-safe
